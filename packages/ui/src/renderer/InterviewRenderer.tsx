    ...
    return (
      <Card style={{ maxWidth: 600, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ 
          ...
          background: mode === 'drill' ? 'var(--ds-color-palette-blue-50)' : mode === 'explain' ? 'var(--ds-color-palette-purple-50)' : 'var(--ds-color-palette-orange-50)',
    ...
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        <div>
          ...
          <div style={{ fontSize: 'var(--ds-spacing-2)', color: 'var(--color-text-secondary)' }}>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          borderRadius: 'var(--ds-spacing-0)',
          transition: 'width var(--ds-motion-duration-slow) ease'
        }} />
      </div>
      ...
      <Card style={{ marginBottom: 'var(--ds-spacing-6)' }}>
        ...
        <textarea
          ...
          style={{
            width: '100%',
            minHeight: 'var(--ds-spacing-28)',
            padding: 'var(--ds-spacing-3)',
            border: 'var(--ds-borderWidth-1) solid var(--color-border)',
            borderRadius: 'var(--ds-spacing-2)',
            fontSize: 'var(--ds-spacing-3)',
            resize: 'vertical'
          }}
        ...
        {mode === 'mock' && (
          <div style={{ marginTop: 'var(--ds-spacing-4)' }}>
            <p style={{ margin: '0 0 8px 0', fontSize: 'var(--ds-spacing-3)' }}>
      ...
      {mode === 'explain' && showAnswer && (
        <Card style={{ marginBottom: 'var(--ds-spacing-6)', background: 'var(--ds-color-palette-blue-50)' }}>
